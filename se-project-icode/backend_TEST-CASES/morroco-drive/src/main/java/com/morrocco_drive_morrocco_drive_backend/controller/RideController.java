...
import com.morrocco_drive_morrocco_drive_backend.dto.StartRideRequest;
...
import com.morrocco_drive_morrocco_drive_backend.service.RideService;
...
public class RideController {
    ...
    public ResponseEntity<RideDto> rideStartHandler(@PathVariable Long rideId,
                                                    @RequestBody StartRideRequest req)
            throws ResourceNotFoundException, UserException {
    ...
    public ResponseEntity<RideDto> rideCompleteHandler(@PathVariable Long rideId)
            throws ResourceNotFoundException {
    ...
    @GetMapping("/{rideId}")
    public ResponseEntity<RideDto> findRideByIdHandler(@PathVariable Long rideId)
            throws ResourceNotFoundException {
